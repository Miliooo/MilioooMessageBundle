...
/**
 * Test file for Miliooo\MessagingBundle\Entity\Thread.
 *
...
class ThreadTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $messageMeta = $this->getMockForAbstractClass('Miliooo\MessagingBundle\Entity\Thread');
        $this->assertInstanceOf('Miliooo\Messaging\Model\Thread', $messageMeta);
    }
}
